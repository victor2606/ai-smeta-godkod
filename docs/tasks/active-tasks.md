...
**Этап 3: Улучшение поиска (опционально, P3)**
...
**Текущая БД покрывает только ~40% полей!**
...
#### ❌ ПРОБЛЕМА 4: Отсутствуют поля по ресурсам
...
1. **Расширить таблицу `rates` — добавить 13 полей иерархии:**
   ```sql
